...
| `bg_redesign_residues`      | null    | Chain A (binder) residues to redesign/rediffuse, comma-separated e.g. `'A10-50,A60'`. If null, the entire chain A binder is redesigned.                                                                                                                                                                                                                                                                                | `boltzgen_redesign`  |
| `bg_flexible_residues`      | null    | Target residues whose structure should NOT be conditioned on, useful for disordered/flexible target regions e.g. loops or IDPs. Comma-separated tokens, each a chain-qualified residue e.g. `'B16'`, a chain-qualified range e.g. `'B10-13'`, or a bare chain ID e.g. `'C'` meaning the whole chain.  | `boltzgen_denovo`, `boltzgen_redesign` |
