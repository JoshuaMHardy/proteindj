...
Metrics assessing the confidence of sequences generated by ProteinMPNN or FAMPNN, and sequence properties using BioPython.
...
| `seq_ext_coef`    | Extinction coefficient at 280 nm (M⁻¹ cm⁻¹).                                                |
